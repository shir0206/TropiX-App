...
public class ChooseMyPlayerRecyclerViewAdapter extends RecyclerView.Adapter<ChooseMyPlayerRecyclerViewAdapter.ViewHolder> {
    ...
    public ChooseMyPlayerRecyclerViewAdapter(Context context, ArrayList<Integer> allId,
